...
let player1 = new Player("Xgamer", "1j5m854i#2n", "xgamer@gmail.com", 0, 0, Date.now(), Date.now(), Date.now(), true);
...
let retour = collectionPlayer.create(player1);
console.log("retour create(player1) " + retour.getUserName());
